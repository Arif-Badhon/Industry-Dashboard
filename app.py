...
def graph_build(type, indicator, Sector):
    ...
    if type == 'Yearly':
        ...
        figure.update_layout(title={'text':"Yearly data plot of "+ indicator + " , Unit of Measure " + str(np.unique(CalenderYearData['Unit'])[0]),  'y':0.9,
        ...
        figure.update_layout(title={'text':"Budget Yearly data plot of "+ indicator + " , Unit of Measure " + str(np.unique(BudgetYearData['Unit'])[0]),  'y':0.9,
